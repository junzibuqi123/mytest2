...
def dealAnnouncePeer(msg,s,adress,q):
    ...
    #print("子线程数量=======》："+str(threading.active_count()))
    #_thread.start_new_thread( peers3.getInfoMessage, (adress,infohash,infohash2,mu, ) )
    t = threading.Thread(target= peers3.getInfoMessage,args=(adress,infohash,infohash2,mu,))
    t.start()
    return
